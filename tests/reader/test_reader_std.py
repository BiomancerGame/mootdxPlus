...
@pytest.mark.parametrize(
    'symbol,adjust,empty', [
        ...
        ('sh881478', '', False),
        ('881478', '', False),
        pytest.param('688001', 'qfq', False, marks=pytest.mark.online),
        pytest.param('000001', 'qfq', False, marks=pytest.mark.online),
        pytest.param('127021', 'qfq', False, marks=pytest.mark.online),
    ])
